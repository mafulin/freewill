 ...
 */
package spirit.freewill.view.indicator;
...
//        final int defaultSelectedColor = 0;
    ...
    public void setViewPager(ViewPager viewPager) {
        ...
        if (viewPager.getAdapter() == null) {
            throw new IllegalStateException("FreeViewPager does not have adapter instance.");
        }
    ...
    public void setCurrentItem(int item) {
        if (mViewPager == null) {
            throw new IllegalStateException("FreeViewPager has not been bound.");
        }
