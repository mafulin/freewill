...
public class FreewillView extends View{

	private float width = Constant.width;
	private float height = Constant.height;
	private long durationMillis = 36000;
	public FreewillView(Context context, AttributeSet attrs, int defStyleAttr) {
		super(context, attrs, defStyleAttr);
	}
	public FreewillView(Context context, AttributeSet attrs) {
		this(context, attrs,0);
	}
	public FreewillView(Context context) {
		this(context,null);
//		setAnimation();
	}
